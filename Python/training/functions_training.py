...
# c) TypedDict                                                                      #Vorteil: Typisierte Dictionaries (ideal für JSON/API-Daten), Optional: Felder können auch optional gemacht werden, perfekt für strukturierte, aber flexible Daten
class UserDict(TypedDict):                                                          #muss von typing importiert werden
    username: str
    age: int
    email: str

def get_user_dict() -> UserDict[str, str]:
    return {
        "username": "Eve",
        "age": 40,
